...
class Student(db.Model):
    ...
    fee_records = db.relationship(
        "Fee", backref="student", lazy=True, cascade="all, delete-orphan"
    )
    marks = db.relationship(
        "Mark", backref="student", lazy=True, cascade="all, delete-orphan"
    )
...
class Batch(db.Model):
    ...
    # Relationships
    attendance_records = db.relationship(
        "Attendance", backref="batch", lazy=True, cascade="all, delete-orphan"
    )
    marks = db.relationship(
        "Mark", backref="batch", lazy=True, cascade="all, delete-orphan"
    )
